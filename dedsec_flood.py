...
def runme():
    print(banner)
    WP = 'https://www.lucky-gift-hunyo.online'
    ip = '13.213.201.36'
  
    table = tabulate([['\033[92mTARGET PHISHING PAGE:\033[0m',WP,'\033[92mTARGET IP: \033[0m', ip]], tablefmt="fancy_grid", stralign="center")
    print(table)
